...
class Fish1 extends StatefulWidget {
  const Fish1({super.key});

  @override
  State<Fish1> createState() => _Fish1State();
}

class _Fish1State extends State<Fish1> {
  final String productName = " APPOLLA FISH FRY";

  final String weight = "SNGLE";
  ...
  final String imageUrl = 'assets/MAGES/appollo fish1.jpg';
