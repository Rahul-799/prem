...
class Fish4 extends StatefulWidget {
  const Fish4({super.key});

  @override
  State<Fish4> createState() => _Fish4State();
}

class _Fish4State extends State<Fish4> {
  final String productName = " TANDOORI FISH FRY";
  ...
  final String imageUrl = 'assets/MAGES/tandoor fish fry.jpg';
