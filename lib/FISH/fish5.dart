...
class Fish5 extends StatefulWidget {
  const Fish5({super.key});

  @override
  State<Fish5> createState() => _Fish5State();
}

class _Fish5State extends State<Fish5> {
  final String productName = " CRISPY POMFRITFRY";
  ...
  final String imageUrl = 'assets/MAGES/crspy pomfretfish fry1.jpg';
