...
class Fish6 extends StatefulWidget {
  const Fish6({super.key});

  @override
  State<Fish6> createState() => _Fish6State();
}

class _Fish6State extends State<Fish6> {
  final String productName = " FISH FRY";
  ...
  final String imageUrl = 'assets/MAGES/fish fry1.jpg';
