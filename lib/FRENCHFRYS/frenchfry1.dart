...
class Frenchfry1 extends StatefulWidget {
  const Frenchfry1({super.key});

  @override
  State<Frenchfry1> createState() => _Frenchfry1State();
}

class _Frenchfry1State extends State<Frenchfry1> {
  final String productName = " FRENCH FRY";
  ...
  final String imageUrl = 'assets/MAGES/french fries.jpg';
