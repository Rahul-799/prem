...
class Frenchfry2 extends StatefulWidget {
  const Frenchfry2({super.key});

  @override
  State<Frenchfry2> createState() => _Frenchfry2State();
}

class _Frenchfry2State extends State<Frenchfry2> {
  final String productName = " PERI PERI";
  ...
  final String imageUrl = 'assets/MAGES/peri peri.jpg';
