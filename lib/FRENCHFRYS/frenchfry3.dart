...
class Frenchfry3 extends StatefulWidget {
  const Frenchfry3({super.key});

  @override
  State<Frenchfry3> createState() => _Frenchfry3State();
}

class _Frenchfry3State extends State<Frenchfry3> {
  final String productName = " CLASSIC SALTED";
  ...
  final String imageUrl = 'assets/MAGES/classic salted.jpg';
