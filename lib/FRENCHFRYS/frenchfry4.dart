...
class Frenchfry4 extends StatefulWidget {
  const Frenchfry4({super.key});

  @override
  State<Frenchfry4> createState() => _Frenchfry4State();
}

class _Frenchfry4State extends State<Frenchfry4> {
  final String productName = " GARLIC MAYO FRIES";
  ...
  final String imageUrl = 'assets/MAGES/garlic mayo fries1.jpg';
