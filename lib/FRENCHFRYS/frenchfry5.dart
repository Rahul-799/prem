...
class Frenchfry5 extends StatefulWidget {
  const Frenchfry5({super.key});

  @override
  State<Frenchfry5> createState() => _Frenchfry5State();
}

class _Frenchfry5State extends State<Frenchfry5> {
  final String productName = " CHEESE FRIES";
  ...
  final String imageUrl = 'assets/MAGES/cheese fries.jpg';
