...
class Frenchfry6 extends StatefulWidget {
  const Frenchfry6({super.key});

  @override
  State<Frenchfry6> createState() => _Frenchfry6State();
}

class _Frenchfry6State extends State<Frenchfry6> {
  final String productName = " LOADED FRIES";
  ...
  final String imageUrl = 'assets/MAGES/loaded fries.jpg';
