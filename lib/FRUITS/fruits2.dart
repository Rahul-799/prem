...
class Fruits2 extends StatefulWidget {
  const Fruits2({super.key});

  @override
  State<Fruits2> createState() => _Fruits2State();
}

class _Fruits2State extends State<Fruits2> {
  ...
  final String imageUrl = 'assets/MAGES/apple.jpg';
