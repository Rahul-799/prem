...
class Fruits3 extends StatefulWidget {
  const Fruits3({super.key});

  @override
  State<Fruits3> createState() => _Fruits3State();
}

class _Fruits3State extends State<Fruits3> {
  final String productName = " PINE APPLE";
  ...
  final String imageUrl = 'assets/MAGES/pineapple fruit.png';
