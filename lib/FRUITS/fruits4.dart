...
class Fruits4 extends StatefulWidget {
  const Fruits4({super.key});

  @override
  State<Fruits4> createState() => _Fruits4State();
}

class _Fruits4State extends State<Fruits4> {
  final String productName = " PROMOGRANATE";
  ...
  final String imageUrl = 'assets/MAGES/pomegranate.jpg';
