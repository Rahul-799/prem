...
class Fruits5 extends StatefulWidget {
  const Fruits5({super.key});

  @override
  State<Fruits5> createState() => _Fruits5State();
}

class _Fruits5State extends State<Fruits5> {
  final String productName = " BLACK GRAPES";
  ...
  final String imageUrl = 'assets/MAGES/black grapes.jpg';
