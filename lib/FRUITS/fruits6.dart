...
class Fruits6 extends StatefulWidget {
  const Fruits6({super.key});

  @override
  State<Fruits6> createState() => _Fruits6State();
}

class _Fruits6State extends State<Fruits6> {
  final String productName = " ORANGES";
  ...
  final String imageUrl = 'assets/MAGES/oranges.jpg';
