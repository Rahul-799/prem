...
class Fruits7 extends StatefulWidget {
  const Fruits7({super.key});

  @override
  State<Fruits7> createState() => _Fruits7State();
}

class _Fruits7State extends State<Fruits7> {
  final String productName = " dragon fruit";
  ...
  final String imageUrl = 'assets/MAGES/dragon fruit.jpg';
