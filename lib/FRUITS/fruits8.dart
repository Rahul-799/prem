...
class Fruits8 extends StatefulWidget {
  const Fruits8({super.key});

  @override
  State<Fruits8> createState() => _Fruits8State();
}

class _Fruits8State extends State<Fruits8> {
  final String productName = " grapes";
  ...
  final String imageUrl = 'assets/MAGES/grapes.jpg';
