...
class Juices2 extends StatefulWidget {
  const Juices2({super.key});

  @override
  State<Juices2> createState() => _Juices2State();
}

class _Juices2State extends State<Juices2> {
  final String productName = " BLUE LAGOON";
  ...
  final String imageUrl = 'assets/MAGES/blue lagoon.jpg';
