...
class Juices3 extends StatefulWidget {
  const Juices3({super.key});

  @override
  State<Juices3> createState() => _Juices3State();
}

class _Juices3State extends State<Juices3> {
  final String productName = " FRUIT PUNCH";
  ...
  final String imageUrl = 'assets/MAGES/fruit punch.png';
