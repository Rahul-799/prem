...
class Juices5 extends StatefulWidget {
  const Juices5({super.key});

  @override
  State<Juices5> createState() => _Juices5State();
}

class _Juices5State extends State<Juices5> {
  final String productName = " MANGO MULE";
  ...
  final String imageUrl = 'assets/MAGES/mango mule.jpg';
