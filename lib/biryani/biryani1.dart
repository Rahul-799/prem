...
class Biryani1 extends StatefulWidget {
  const Biryani1({super.key});

  @override
  State<Biryani1> createState() => _Biryani1State();
}

class _Biryani1State extends State<Biryani1> {
  final String productName = "DUM BIRYANI";
  final String productImage =
      'assets/MAGES/dum biryani.jpg'; // Replace with actual image
