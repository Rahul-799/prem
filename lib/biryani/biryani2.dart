...
class Biryani2 extends StatefulWidget {
  const Biryani2({super.key});

  @override
  State<Biryani2> createState() => _Biryani2State();
}

class _Biryani2State extends State<Biryani2> {
  final String productName = "CHITTY MUTHYALI BIRYANI";
  ...
  final String imageUrl = 'assets/MAGES/chitty muthyala biryani.jpg';
