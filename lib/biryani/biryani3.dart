...
class Biryani3 extends StatefulWidget {
  const Biryani3({super.key});

  @override
  State<Biryani3> createState() => _Biryani3State();
}

class _Biryani3State extends State<Biryani3> {
  final String productName = "MUTTON BIRYANI";
  ...
  final String imageUrl = 'assets/MAGES/mutton biryani.jpg';
