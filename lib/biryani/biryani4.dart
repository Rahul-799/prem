...
class Biryani4 extends StatefulWidget {
  const Biryani4({super.key});

  @override
  State<Biryani4> createState() => _Biryani4State();
}

class _Biryani4State extends State<Biryani4> {
  final String productName = "VEG BIRYANI";
  ...
  final String imageUrl = 'assets/MAGES/veg biryani.jpg';
