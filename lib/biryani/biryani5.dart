...
class Biryani5 extends StatefulWidget {
  const Biryani5({super.key});

  @override
  State<Biryani5> createState() => _Biryani5State();
}

class _Biryani5State extends State<Biryani5> {
  final String productName = "EGG BIRYANI";
  ...
  final String imageUrl = 'assets/MAGES/egg biryani.webp';
