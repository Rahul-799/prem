...
class Biryani6 extends StatefulWidget {
  const Biryani6({super.key});

  @override
  State<Biryani6> createState() => _Biryani6State();
}

class _Biryani6State extends State<Biryani6> {
  final String productName = "PRAWNS BIRYANI";
  ...
  final String imageUrl = 'assets/MAGES/prawns biryani.jpg';
