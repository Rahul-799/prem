...
class buyall extends StatefulWidget {
  const buyall({super.key});

  @override
  State<buyall> createState() => _buyallState();
}

class _buyallState extends State<buyall> {
  final String productName = "Mango-Papaya Mix";
  final String productImage =
      'assets/MAGES/chckn-llypop.jpg'; // Replace with actual image
