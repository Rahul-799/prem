...
class Chicken1 extends StatefulWidget {
  const Chicken1({super.key});

  @override
  State<Chicken1> createState() => _Chicken1State();
}

class _Chicken1State extends State<Chicken1> {
  final String productName = "Boneless kaju Chicken Fry";
  ...
  final String imageUrl = 'assets/MAGES/bone less kaju chicken.jpg';
