...
class Chicken10 extends StatefulWidget {
  const Chicken10({super.key});

  @override
  State<Chicken10> createState() => _Chicken10State();
}

class _Chicken10State extends State<Chicken10> {
  final String productName = "CHICKEN FRY";
  ...
  final String imageUrl = 'assets/MAGES/Chicken fry1.jpg';
