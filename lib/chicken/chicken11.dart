...
class Chicken11 extends StatefulWidget {
  const Chicken11({super.key});

  @override
  State<Chicken11> createState() => _Chicken11State();
}

class _Chicken11State extends State<Chicken11> {
  final String productName = "CHILLY CHICKEN";
  ...
  final String imageUrl = 'assets/MAGES/chilly Chicken1.jpg';
