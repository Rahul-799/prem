...
class Chicken12 extends StatefulWidget {
  const Chicken12({super.key});

  @override
  State<Chicken12> createState() => _Chicken12State();
}

class _Chicken12State extends State<Chicken12> {
  final String productName = "GHEE ROSTED CHICKEN";
  ...
  final String imageUrl = 'assets/MAGES/green rosted Chicken.jpg';
