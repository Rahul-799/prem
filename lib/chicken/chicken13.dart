...
class Chicken13 extends StatefulWidget {
  const Chicken13({super.key});

  @override
  State<Chicken13> createState() => _Chicken13State();
}

class _Chicken13State extends State<Chicken13> {
  final String productName = "CHICKEN CURRY";
  ...
  final String imageUrl = 'assets/MAGES/Chicken curry.jpg';
