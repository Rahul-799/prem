...
class Chicken14 extends StatefulWidget {
  const Chicken14({super.key});

  @override
  State<Chicken14> createState() => _Chicken14State();
}

class _Chicken14State extends State<Chicken14> {
  final String productName = "BUTTER CHICKEN CURRY";
  ...
  final String imageUrl = 'assets/MAGES/butter Chicken curry1.jpg';
