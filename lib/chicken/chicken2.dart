...
class Chicken2 extends StatefulWidget {
  const Chicken2({super.key});

  @override
  State<Chicken2> createState() => _Chicken2State();
}

class _Chicken2State extends State<Chicken2> {
  final String productName = "CHICKEN 65";
  ...
  final String imageUrl = 'assets/MAGES/chicken 65.jpeg';
