...
class Chicken3 extends StatefulWidget {
  const Chicken3({super.key});

  @override
  State<Chicken3> createState() => _Chicken3State();
}

class _Chicken3State extends State<Chicken3> {
  final String productName = "CHICKEN LOLIPOP";
